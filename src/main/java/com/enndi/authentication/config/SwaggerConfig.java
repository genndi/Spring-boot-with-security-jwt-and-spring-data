...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API de autenticação", "Esta API é utilizada como base para aplicações Spring Boot",
				"Versão 1.0", "https://github.com/G-Enndi/Spring-boot-with-security-jwt-and-spring-data",
				new Contact("Gustavo", "-", "-"), "Permitido uso para estudantes", "-", Collections.emptyList() // Vendor
																												// Extensions
		);
	}
